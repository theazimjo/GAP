...
let TurnsController = class TurnsController {
    ...
    async generate(body, req) {
        return this.turnsService.generateTurns(body.groupId, body.startDate, body.frequencyDays, req.user.userId);
    }
...
], TurnsController.prototype, "generate", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TurnsController.prototype, "findByGroup", null);
